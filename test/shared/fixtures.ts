...
import UniswapV3Pool from '@thinkincoin-libs/uniswap-v3-core/artifacts/contracts/UniswapV3Pool.sol/UniswapV3Pool.json'
import UniswapV3FactoryJson from '@thinkincoin-libs/uniswap-v3-core/artifacts/contracts/UniswapV3Factory.sol/UniswapV3Factory.json'
import NFTDescriptorJson from '@thinkincoin-libs/uniswap-v3-periphery/artifacts/contracts/libraries/NFTDescriptor.sol/NFTDescriptor.json'
import NonfungiblePositionManagerJson from '@thinkincoin-libs/uniswap-v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
import NonfungibleTokenPositionDescriptor from '@thinkincoin-libs/uniswap-v3-periphery/artifacts/contracts/NonfungibleTokenPositionDescriptor.sol/NonfungibleTokenPositionDescriptor.json'
import SwapRouter from '@thinkincoin-libs/uniswap-v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
